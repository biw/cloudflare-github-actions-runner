/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3efa2d34a2a31bcd084d044d9b8c24c7)
// Runtime types generated with workerd@1.20260811.1 2026-08-12 nodejs_compat
interface __BaseEnv_Env {
	RUNNER_CACHE: R2Bucket;
	RUNNER_IMAGE_SOURCE: R2Bucket;
	RESOURCE_METRICS: D1Database;
	LEGACY_GITHUB_OWNER: "biw";
	LEGACY_GITHUB_REPOSITORY: "cloudflare-github-actions-runner";
	GITHUB_RUNNER_GROUP_ID: "1";
	RUNNER_APPLICATION_PREFIX: "cloudflare-github-actions-runner";
	CUSTOM_RUNNER_APPLICATION: "cloudflare-github-actions-runner-custom";
	RUNNER_IMAGE_BUILDER_APPLICATION: "cloudflare-github-actions-runner-image-builder";
	RUNNER_IMAGE_BUILDER_IMAGE_NAME: "cloudflare-github-actions-runner-image-builder";
	RUNNER_IMAGE_BUILDER_BOOTSTRAP_DEPLOYMENT_ID: "unconfigured";
	...
	RUNNER_LITE: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerLite>;
	RUNNER_VALIDATION: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerValidation>;
	RUNNER_BASIC: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerBasic>;
	RUNNER_STANDARD_1: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerStandard1>;
	RUNNER_STANDARD_2: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerStandard2>;
	RUNNER_STANDARD_3: DurableObjectNamespace<import("./src/index").GitHubActionsRunner>;
	RUNNER_STANDARD_4: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerStandard4>;
	RUNNER_CUSTOM: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom>;
	RUNNER_CUSTOM_2: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom2>;
	RUNNER_CUSTOM_3: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom3>;
	RUNNER_CUSTOM_4: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom4>;
	RUNNER_CUSTOM_5: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom5>;
	RUNNER_CUSTOM_6: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom6>;
	RUNNER_CUSTOM_7: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom7>;
	RUNNER_CUSTOM_8: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom8>;
	RUNNER_CUSTOM_9: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom9>;
	RUNNER_CUSTOM_10: DurableObjectNamespace<import("./src/index").GitHubActionsRunnerCustom10>;
	RUNNER_SCHEDULER: DurableObjectNamespace<import("./src/index").AccountRunnerScheduler>;
	RUNNER_ELIGIBILITY_CHECK: DurableObjectNamespace<import("./src/index").RunnerEligibilityCheck>;
	RUNNER_CACHE_QUOTA: DurableObjectNamespace<import("./src/index").RunnerCacheQuota>;
	RUNNER_IMAGE_BUILDER: DurableObjectNamespace<import("./src/index").RunnerImageBuilder>;
	RUNNER_PROVISIONING_WORKFLOW: Workflow<Parameters<import("./src/index").RunnerProvisioningWorkflow['run']>[0]['payload']>;
	RUNNER_IMAGE_BUILD_WORKFLOW: Workflow<Parameters<import("./src/index").RunnerImageBuildWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GitHubActionsRunner" | "GitHubActionsRunnerLite" | "GitHubActionsRunnerBasic" | "GitHubActionsRunnerStandard1" | "GitHubActionsRunnerStandard2" | "GitHubActionsRunnerStandard4" | "GitHubActionsRunnerCustom" | "GitHubActionsRunnerCustom2" | "GitHubActionsRunnerCustom3" | "GitHubActionsRunnerCustom4" | "GitHubActionsRunnerCustom5" | "GitHubActionsRunnerCustom6" | "GitHubActionsRunnerCustom7" | "GitHubActionsRunnerCustom8" | "GitHubActionsRunnerCustom9" | "GitHubActionsRunnerCustom10" | "AccountRunnerScheduler" | "GitHubActionsRunnerValidation" | "RunnerCacheQuota" | "RunnerImageBuilder" | "RunnerEligibilityCheck";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LEGACY_GITHUB_OWNER" | "LEGACY_GITHUB_REPOSITORY" | "GITHUB_RUNNER_GROUP_ID" | "RUNNER_APPLICATION_PREFIX" | "CUSTOM_RUNNER_APPLICATION" | "RUNNER_IMAGE_BUILDER_APPLICATION" | "RUNNER_IMAGE_BUILDER_IMAGE_NAME" | "RUNNER_IMAGE_BUILDER_BOOTSTRAP_DEPLOYMENT_ID" | "RUNNER_IMAGE_NAME" | "RUNNER_IMAGE_SOURCE_REPOSITORY" | "RUNNER_IMAGE_SOURCE_REF" | "RUNNER_CACHE_ENABLED" | "RUNNER_CACHE_MAX_BYTES" | "RUNNER_CACHE_PREFIX">> {}
}
